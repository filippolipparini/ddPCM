...
\]
\color{red}
Ben: isn't it advantageous to write ${A_\infty}^*\, s = ({A_\infty}^*-{A_\varepsilon}^*)\, s + y$ since ${A_\varepsilon}^*$ and ${A_\infty}^*$ only differ by a diagonal term? Paolo: yes, and I think we should do it. However, it does not change the overall complexity that is dictated by the derivative term...
\color{black}
