\documentclass[aip,jcp,a4paper]{revtex4-1}
...
The methodological development started with the so-called ddCOSMO method and has recently be generalized to the PCM equation resulting in the ddPCM-method [Stamm {\it et al.}, J. Chem. Phys. 144, 054101 (2016)] for which the forces are addressed within this article. 
